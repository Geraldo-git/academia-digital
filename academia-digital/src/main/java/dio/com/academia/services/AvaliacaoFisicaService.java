...
public class AvaliacaoFisicaService {
	...
	public AvaliacaoFisicaDTO findById(Long id) {
		AvaliacaoFisica matricula = repository.findById(id)
				.orElseThrow(() -> new ResourceNotFoundException("AvaliacaoFisica não encontrada!"));
	...
	public Page<AvaliacaoFisicaDTO> findAll(Pageable pageable) {
		...
		// AvaliacaoFisicaDTO(x)).collect(Collectors.toList());
